...
function CommandSurface({ close, openCapture, openTask, openProject, openWorkspace, openApp }: { close: () => void; openCapture: (capture: Capture) => void; openTask: (task: Task) => void; openProject: (project: Project) => void; openWorkspace: (workspace: Workspace) => void; openApp: (app: RegisteredApp) => void }) {
