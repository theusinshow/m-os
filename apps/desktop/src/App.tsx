...
import type { AppLaunchKind, AppStatus, BackupInspection, Capture, Project, RegisteredApp, SearchItem, Task, TaskState, UpdateInfo, UpdateProgress, Workspace } from "./types";
import "./App.css";
