...
pub fn function_registry() -> Vec<FunctionDefinition> {
    vec![
        ...
        function(
            "meeting.start",
            "Iniciar reuniao",
            "Comeca a gravar microfone e audio do sistema. Nunca acontece sem um gesto seu. Ctrl+Alt+M.",
            FunctionCategory::Meeting,
            FunctionRisk::Low,
            FunctionConfirmation::None,
        ),
        function(
            "meeting.open_current",
            "Abrir reuniao atual",
            "Abre a reuniao que esta sendo gravada.",
            FunctionCategory::Meeting,
            FunctionRisk::Low,
            FunctionConfirmation::None,
        ),
        function(
            "meeting.mark_moment",
            "Marcar momento da reuniao",
            "Marca este instante da gravacao como importante. Ctrl+Alt+M durante a gravacao.",
            FunctionCategory::Meeting,
            FunctionRisk::Low,
            FunctionConfirmation::None,
        ),
        function(
            "meeting.pause",
            "Pausar reuniao",
            "Suspende a gravacao sem encerrar.",
            FunctionCategory::Meeting,
            FunctionRisk::Low,
            FunctionConfirmation::None,
        ),
        function(
            "meeting.resume",
            "Retomar reuniao",
            "Volta a gravar a reuniao pausada.",
            FunctionCategory::Meeting,
            FunctionRisk::Low,
            FunctionConfirmation::None,
        ),
        function(
            "meeting.stop",
            "Encerrar reuniao",
            "Encerra a gravacao. Transcricao e organizacao comecam sozinhas. Ctrl+Alt+Shift+M.",
            FunctionCategory::Meeting,
            FunctionRisk::Low,
            FunctionConfirmation::None,
        ),
